...
marathon_kb_2.add(InlineKeyboardButton(text='Я готов!',callback_data='l1'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))

marathon_kb_2_1 = InlineKeyboardMarkup(row_width=1)
marathon_kb_2_1.add(InlineKeyboardButton(text='Дальше',callback_data='l2'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
