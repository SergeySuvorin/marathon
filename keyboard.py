...
quest_kb.add(InlineKeyboardButton(text='Следующая практика', callback_data='l3'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
...
next_pract.add(InlineKeyboardButton(text='Следующая практика',callback_data='l4'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
...
sory_kb.add(InlineKeyboardButton(text='Ответил, идем дальше!', callback_data='ris_2'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
...
next_ex.add(InlineKeyboardButton(text='Следующая практика', callback_data='next_ex'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
...
day_6.add(InlineKeyboardButton(text='Новая практика!',callback_data='day_6'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))
...
day_6_4.add(InlineKeyboardButton(text='Последняя практика!',callback_data='day_6_4'),InlineKeyboardButton(text='Главное меню', callback_data='glav'))


day_7 = InlineKeyboardMarkup(row_width=1)
day_7.add(InlineKeyboardButton(text='Создать!',callback_data='day_7'))

day_7_2 = InlineKeyboardMarkup(row_width=1)
day_7_2.add(InlineKeyboardButton(text='Получить подарки!🎁',callback_data='day_7_2'),InlineKeyboardButton(text='Оставить отзыв😀', url = 'https://t.me/psyhologspbg'))